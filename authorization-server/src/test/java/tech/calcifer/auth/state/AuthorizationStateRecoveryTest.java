...
class AuthorizationStateRecoveryTest {
  ...
  void stableConnectivityAdvancesExactlyOnceAndDiscardsIsolation() {
    ...
    AuthorizationStateManager state = AuthorizationStateRoutingTest.manager(bytes,
        AuthorizationStateRoutingTest.properties(AuthorizationStateProperties.Role.HOME, 1), clock);
