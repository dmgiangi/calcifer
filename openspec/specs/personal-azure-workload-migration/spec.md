# Personal Azure workload migration

## Purpose

Define the approved Azure topology, protected backup migration, and functional acceptance requirements for personal workloads.
