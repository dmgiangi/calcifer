# Home observability collection

## Purpose

Define collection and durable forwarding of metrics and workload logs from
`calcifer-home` through Grafana Alloy to the central observability backends.
