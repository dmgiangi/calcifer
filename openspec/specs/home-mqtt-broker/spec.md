# home-mqtt-broker Specification

## Purpose
Provide a persistent, authenticated MQTT broker for Home Assistant and Zigbee2MQTT on `calcifer-home`, including secure secret reconciliation and reliable discovery traffic.
