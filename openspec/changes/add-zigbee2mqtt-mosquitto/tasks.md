...
- [ ] 4.2 Reconcile the Home Flux resources and verify Certificate readiness, DNS resolution, broker authentication, and TLS connectivity on `mqtt.calcifer.tech:8883`.
